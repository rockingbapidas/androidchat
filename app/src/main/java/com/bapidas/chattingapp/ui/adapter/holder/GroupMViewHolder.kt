 ...
 */
class GroupMViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView),
    ...
    fun setHolderData(groupM: GroupM, clickGroup: ClickGroup?) {
        subHolder.visibility = View.VISIBLE
        itemView.visibility = View.VISIBLE
        this.clickGroup = clickGroup
        emailId.visibility = View.GONE
        userName.text = groupM.name
        getLastMessage(groupM)
    }

    private fun getLastMessage(groupM: GroupM) {
        checkRooms(groupM, object : ResultInterface {
